      ...
      <div id="view" className="h-full w-screen flex flex-row" x-data="{ sidenav: true }">
        ...
        <div id="sidebar" className="bg-white h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out" x-show="sidenav">
          <div className="space-y-6 md:space-y-10 mt-10">
            ...
            <h1 className="hidden md:block font-bold text-sm md:text-xl text-center">Dashwind
            ...
            <div id="menu" className="flex flex-col space-y-2">
              <a href="" className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-gradient-to-tr from-blue-800 to-purple-700 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
              >
                <svg
              ...
              <a
                href=""
                className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-gradient-to-tr from-blue-800 to-purple-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
              >
                <svg
                  className="w-6 h-6 fill-current inline-block"
                  fill="currentColor"
