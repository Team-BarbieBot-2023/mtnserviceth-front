            ...
            <Tab
              ...
              title={
                <div className="flex items-center space-x-2">
                  ...
                  <span>Warn</span>
                  <Chip size="sm" className="bg-yellow-300" variant="shadow">{data.filter(o => o.complaint_result === 'warn').length}</Chip>
                </div>
              }
            >
              <Card><CardBody>
            ...
            <Tab
              ...
              title={
                <div className="flex items-center space-x-2">
                  ...
                  <span>Replace Technician</span>
                  <Chip size="sm" className="bg-yellow-300" variant="shadow">{data.filter(o => o.complaint_result === 'replace').length}</Chip>
                </div>
              }
            >
              <Card><CardBody>
            ...
            <Tab
              ...
              title={
                <div className="flex items-center space-x-2">
                  ...
                  <span>Ban Technician</span>
                  <Chip size="sm" color="danger" variant="shadow">{data.filter(o => o.complaint_result === 'baned').length}</Chip>
                </div>
              }
            >
              <Card><CardBody>
